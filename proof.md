...
_Generated 2026-09-11 11:25 UTC from live data — last 24h_

## Collection health
- collection runs: **1206 total, 1022 ok, 182 failed** (85% uptime)
- prices collected: **109,455** across **99** events
- snapshots: **2024** over **787 minutes** of observation
  - DAZN Bet (altenar): 66 events, 38,826 prices
  - BetMGM (entain): 17 events, 35,694 prices
  - BetRivers (kambi): 61 events, 29,069 prices
...
- exact markets priced by 2 or more engines: **4,384**
- measured pairwise price agreement (identical price on the same exact bet):
  ...
  | betmgm vs dazn_bet | 1,733 | 2.4% |
  | betrivers_on vs dazn_bet | 1,994 | 2.2% |
...
## Consensus depth — how many engines actually price each market
  ...
  |---|---:|---:|---:|---:|
  | total | 4,175 | 1.80 | 376 | 689 |
  | spread | 3,818 | 1.96 | 580 | 733 |
  | team_total | 2,846 | 1.27 | 18 | 392 |
...
- observed window: **787 minutes**, 2030 snapshots
- unbiased (randomised collection order): **706 minutes**
...
- opportunities detected: **511**
- passed clean (zero warnings): **71**
- flagged or withheld: **440** (86% of everything found)
- rated high confidence: **8**
- average quoted edge, clean rows: **1.02%**
- average quoted edge, flagged rows: **5.06%**
...
- observed window: **787 minutes**, 2024 snapshots
  ...
  | BetRivers | kambi | 3064 | 1623 | 1441 | 47.0% |
  | DAZN Bet | altenar | 2248 | 1954 | 294 | 13.1% |
