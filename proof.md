...
_Generated 2026-09-11 08:25 UTC from live data — last 24h_

## Collection health
- collection runs: **944 total, 812 ok, 130 failed** (86% uptime)
- prices collected: **98,384** across **98** events
- snapshots: **1499** over **605 minutes** of observation
  - DAZN Bet (altenar): 66 events, 33,406 prices
  - BetMGM (entain): 17 events, 35,694 prices
  - BetRivers (kambi): 59 events, 23,418 prices
...
- observed window: **608 minutes**, 1506 snapshots
- unbiased (randomised collection order): **526 minutes**
...
- opportunities detected: **473**
- passed clean (zero warnings): **70**
- flagged or withheld: **403** (85% of everything found)
- rated high confidence: **8**
- average quoted edge, clean rows: **1.02%**
- average quoted edge, flagged rows: **5.48%**
