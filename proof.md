...
_Generated 2026-09-12 05:12 UTC from live data — last 24h_

## Collection health
- collection runs: **1362 total, 1197 ok, 147 failed** (88% uptime)
- prices collected: **408,055** across **231** events
- snapshots: **7697** over **1438 minutes** of observation
  - DAZN Bet (altenar): 240 events, 145,584 prices
  - BetMGM (entain): 85 events, 174,241 prices
  - bwin (entain): 14 events, 24,554 prices
  - BetRivers (kambi): 193 events, 112,545 prices
  - NEO.bet (neo): 47 events, 7,866 prices
...
- exact markets priced by 2 or more engines: **16,138**
- measured pairwise price agreement (identical price on the same exact bet):
  ...
  | betmgm vs betrivers_on | 7,601 | 10.1% |
  | betrivers_on vs neobet | 762 | 9.3% |
  | bwin vs dazn_bet | 1,958 | 2.3% |
  | dazn_bet vs neobet | 718 | 2.1% |
  | betrivers_on vs dazn_bet | 7,284 | 1.7% |
  | betrivers_on vs pinnacle | 4,001 | 1.7% |
  | betmgm vs dazn_bet | 6,717 | 1.5% |
  | dazn_bet vs pinnacle | 2,698 | 1.0% |
  | bwin vs pinnacle | 776 | 0.9% |
  | betmgm vs pinnacle | 2,422 | 0.9% |
...
## Consensus depth — how many engines actually price each market
  ...
  |---|---:|---:|---:|---:|
  | spread | 14,450 | 1.85 | 1,191 | 2,994 |
  | total | 13,832 | 1.88 | 1,140 | 3,266 |
  | team_total | 4,726 | 1.35 | 84 | 844 |
...
- observed window: **1440 minutes**, 7703 snapshots
- unbiased (randomised collection order): **1774 minutes**
...
- nothing clears the sample and significance bar
  ...
  |---|---:|---:|---|
  | neo → kambi | 23 | 100.0% | polling artifact |
  | pinnacle → neo | 3 | 100.0% | polling artifact |
  | kambi → neo | 12 | 100.0% | polling artifact |
  | neo → altenar | 5 | 100.0% | polling artifact |
  | kambi → pinnacle | 18 | 94.4% | polling artifact |
  | pinnacle → altenar | 47 | 74.5% | polling artifact |
  | altenar → pinnacle | 65 | 72.3% | polling artifact |
  | entain → altenar | 501 | 60.3% | polling artifact |
  | altenar → entain | 374 | 58.6% | polling artifact |
  | entain → pinnacle | 45 | 57.8% | polling artifact |
  | altenar → kambi | 39 | 56.4% | polling artifact |
  | kambi → altenar | 41 | 56.1% | polling artifact |
  | pinnacle → entain | 44 | 50.0% | polling artifact |
  | pinnacle → kambi | 16 | 37.5% | polling artifact |
  | entain → kambi | 20 | 35.0% | polling artifact |
  | kambi → entain | 6 | 33.3% | polling artifact |
  | altenar → neo | 8 | 12.5% | polling artifact |
...
- opportunities detected: **1,045**
- passed clean (zero warnings): **81**
- flagged or withheld: **964** (92% of everything found)
- rated high confidence: **20**
- average quoted edge, clean rows: **1.93%**
- average quoted edge, flagged rows: **1.60%**
...
## Line shopping value
- comparable bets priced by 3+ engines, every price confirmed within **20 minutes** of the others: **4,782**
- best price vs the **median** price: **1.94%** — what shopping saves a typical bettor, and the figure we advertise
- best price vs the **worst** price: **4.68%** — the spread across the market, a different question
...
- observed window: **1438 minutes**, 7697 snapshots

  | book | engine | active bets | repriced | held | stale % |
  |---|---|---:|---:|---:|---:|
  | BetRivers | kambi | 12255 | 6790 | 5465 | 44.6% |
  | Pinnacle | pinnacle | 7097 | 5182 | 1915 | 27.0% |
  | bwin | entain | 3857 | 2859 | 998 | 25.9% |
  | DAZN Bet | altenar | 11808 | 8949 | 2859 | 24.2% |
  | BetMGM | entain | 11655 | 9023 | 2632 | 22.6% |
  | NEO.bet | neo | 1110 | 938 | 172 | 15.5% |
...
- opportunities logged and awaiting settlement: **1,947**
