...
_Generated 2026-09-11 14:19 UTC from live data — last 24h_

## Collection health
- collection runs: **1421 total, 1208 ok, 212 failed** (85% uptime)
- prices collected: **166,885** across **92** events
- snapshots: **2853** over **958 minutes** of observation
  - DAZN Bet (altenar): 70 events, 48,679 prices
  - BetMGM (entain): 32 events, 61,185 prices
  - bwin (entain): 14 events, 14,998 prices
  - BetRivers (kambi): 62 events, 32,775 prices
  - NEO.bet (neo): 33 events, 3,264 prices
...
- measured pairwise price agreement (identical price on the same exact bet):
  ...
  | betrivers_on vs dazn_bet | 2,146 | 2.7% |
  | dazn_bet vs neobet | 530 | 2.5% |
  | betrivers_on vs pinnacle | 1,296 | 2.3% |
  | betmgm vs dazn_bet | 2,110 | 1.9% |
  | bwin vs dazn_bet | 1,562 | 1.8% |
...
- observed window: **958 minutes**, 2853 snapshots
- unbiased (randomised collection order): **881 minutes**
...
- nothing clears the sample and significance bar
  ...
  | kambi → entain | 63 | 57.1% | polling artifact |
  | altenar → kambi | 25 | 52.0% | polling artifact |
  | neo → pinnacle | 4 | 50.0% | polling artifact |
  | pinnacle → altenar | 22 | 45.5% | noise |
  | pinnacle → entain | 79 | 43.0% | noise |
  | altenar → entain | 204 | 36.3% | polling artifact |
...
- opportunities detected: **449**
- passed clean (zero warnings): **96**
- flagged or withheld: **353** (79% of everything found)
- rated high confidence: **14**
- average quoted edge, clean rows: **0.79%**
...
- observed window: **958 minutes**, 2853 snapshots
  ...
  |---|---|---:|---:|---:|---:|
  | BetRivers | kambi | 3649 | 1969 | 1680 | 46.0% |
  | Pinnacle | pinnacle | 2383 | 1589 | 794 | 33.3% |
  | bwin | entain | 3411 | 2342 | 1069 | 31.3% |
  | BetMGM | entain | 4467 | 3164 | 1303 | 29.2% |
  | NEO.bet | neo | 1055 | 832 | 223 | 21.1% |
  | DAZN Bet | altenar | 2494 | 2080 | 414 | 16.6% |
...
- opportunities logged and awaiting settlement: **647**
