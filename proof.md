...
_Generated 2026-09-11 00:40 UTC from live data — last 24h_

## Collection health
- collection runs: **228 total, 224 ok, 2 failed** (98% uptime)
- prices collected: **67,637** across **95** events
- snapshots: **563** over **143 minutes** of observation
  - DAZN Bet (altenar): 63 events, 17,460 prices
  - BetMGM (entain): 17 events, 27,172 prices
  - BetRivers (kambi): 53 events, 17,354 prices
  - NEO.bet (neo): 30 events, 2,117 prices
...
- measured pairwise price agreement (identical price on the same exact bet):
  ...
  |---|---:|---:|
  | betmgm vs neobet | 674 | 12.9% |
  | betmgm vs betrivers_on | 2,559 | 10.5% |
...
- observed window: **143 minutes**, 563 snapshots
- unbiased (randomised collection order): **62 minutes**
...
- flagged or withheld: **277** (80% of everything found)
- rated high confidence: **30**
- average quoted edge, clean rows: **1.09%**
- average quoted edge, flagged rows: **3.76%**
...
## Line shopping value
- comparable bets priced by 3+ engines, every price confirmed within **5 minutes** of the others: **1,955**
...
- observed window: **143 minutes**, 563 snapshots
  ...
  | BetMGM | entain | 1826 | 1021 | 805 | 44.1% |
