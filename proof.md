...
_Generated 2026-09-11 10:00 UTC from live data — last 24h_

## Collection health
- collection runs: **1082 total, 923 ok, 158 failed** (85% uptime)
- prices collected: **104,833** across **99** events
- snapshots: **1803** over **702 minutes** of observation
  - DAZN Bet (altenar): 66 events, 36,616 prices
  - BetMGM (entain): 17 events, 35,694 prices
  - BetRivers (kambi): 61 events, 26,657 prices
...
- exact markets priced by 2 or more engines: **4,364**
- measured pairwise price agreement (identical price on the same exact bet):
  ...
  | betrivers_on vs dazn_bet | 1,974 | 2.2% |
...
## Consensus depth — how many engines actually price each market
  ...
  |---|---:|---:|---:|---:|
  | total | 4,130 | 1.81 | 376 | 669 |
  | spread | 3,798 | 1.96 | 580 | 733 |
...
- observed window: **703 minutes**, 1804 snapshots
- unbiased (randomised collection order): **621 minutes**
...
- opportunities detected: **502**
- passed clean (zero warnings): **70**
- flagged or withheld: **432** (86% of everything found)
- rated high confidence: **6**
- average quoted edge, clean rows: **1.02%**
- average quoted edge, flagged rows: **5.17%**
...
- observed window: **702 minutes**, 1803 snapshots

  | book | engine | active bets | repriced | held | stale % |
  |---|---|---:|---:|---:|---:|
  | Pinnacle | pinnacle | 1433 | 477 | 956 | 66.7% |
  | NEO.bet | neo | 605 | 237 | 368 | 60.8% |
  | BetMGM | entain | 2775 | 1409 | 1366 | 49.2% |
  | BetRivers | kambi | 2965 | 1515 | 1450 | 48.9% |
  | DAZN Bet | altenar | 2230 | 1943 | 287 | 12.9% |
